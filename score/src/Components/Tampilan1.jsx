        ...
        <CardBody>
          <form onSubmit={handleSubmit}>
            <Row>
              <Col md={5}>
                <FormGroup>
                  <Label for="inputTim1" className="text-white" style={{fontFamily: 'calibri'}}>Masukkan Nama Tim 1:</Label>
                  <Input
                    type="text"
                    id="inputTim1"
                    name="inputTim1"
              ...
              <Col md={5}>
                <FormGroup>
                  <Label for="inputTim2" className="text-white" style={{fontFamily: 'calibri'}}>Masukkan Nama Tim 2:</Label>
                  <Input
                    type="text"
                    id="inputTim2"
                    name="inputTim2"
            ...
            <Row className="mt-4">
              <Col className="d-flex justify-content-center">
                <FormGroup className="d-flex flex-column align-items-center">
                  <Label for="waktu" className="text-center mb-2 text-white" style={{fontFamily: 'calibri'}}>Masukkan Waktu Pertandingan (dalam menit):</Label>
                  <Input
                    type="number"
                    id="waktu"
                    name="waktu"
            ...
            <Row className="mt-4">
              <Col className="d-flex justify-content-center">
                <Button type="submit" color="primary">Mulai</Button>
              </Col>
            </Row>
          </form>
        </CardBody>
